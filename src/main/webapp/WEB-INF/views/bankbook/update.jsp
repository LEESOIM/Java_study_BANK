		...
		<form action="update.iu" method="post">
			...
			<div class="mb-3">
				...
				<input type="text" name=bookName class="form-control"
					id="exampleFormControlInput1" value="${dto.bookName }">
			</div>
			<div class="mb-3">
				<label for="exampleFormControlTextarea1" class="form-label">이자율</label>
				<input type="text" name="bookRate" class="form-control"
					id="exampleFormControlTextarea1" value="${dto.bookRate }">
			</div>
			<div class="mb-3">
				<label for="exampleFormControlTextarea1" class="form-label">상세설명</label>
				<textarea class="form-control" name="bookContents"
					id="exampleFormControlTextarea1" rows="3">${dto.bookContents }</textarea>
			</div>
