...
<section class="container-fluid col-lg-5 mt-5">
	<h1 class="mb-5 fw-normal text-center">글쓰기</h1>
	...
	<div class="mb-3">
	  ...
	  <input type="text" name="writer" class="form-control" id="exampleFormControlInput1" readonly="readonly" value="${sessionScope.success.userName }">
	</div>
